  ...
  if (error || !cycle) {
    return (
      <div className="p-8 text-center text-destructive">
        ...
        <Button className="mt-4 block mx-auto" variant="outline" onClick={() => router.push("/hr/performance")}>
          Back
        </Button>
      </div>
    );
      ...
      <div className="border-b bg-card p-4 sm:p-6 shrink-0 space-y-4">
        <div className="flex flex-col lg:flex-row lg:items-start gap-4 justify-between">
          <div className="flex items-start gap-3">
            <Button variant="ghost" size="icon" onClick={() => router.push("/hr/performance")}>
