  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className={cn(
          "w-full sm:max-w-[600px] p-0 flex flex-col gap-0 overflow-hidden",
          "h-full max-h-dvh",
        )}
      >
        <SheetHeader className="p-4 pr-12 border-b space-y-3 text-left shrink-0">
        ...
        {loading && !top ? (
          ...
          <Tabs value={tab} onValueChange={setTab} className="flex-1 flex flex-col min-h-0">
            <TabsList className="w-full justify-start rounded-none border-b bg-muted/30 p-1 h-auto flex-wrap shrink-0">
