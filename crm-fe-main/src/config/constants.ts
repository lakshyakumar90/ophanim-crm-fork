...
export const LEAD_STATUS_CONFIG: StatusConfig[] = [
  ...
  },
  {
    value: "did_not_pick",
    label: "Did Not Pick",
    color: "bg-orange-100 text-orange-800 dark:bg-orange-950/50 dark:text-orange-300",
  },
  {
    value: "follow_up",
    label: "Follow Up",
    color: "bg-indigo-100 text-indigo-800 dark:bg-indigo-950/50 dark:text-indigo-300",
  },
  {
    value: "future_lead",
    label: "Future Lead",
    color: "bg-cyan-100 text-cyan-800 dark:bg-cyan-950/50 dark:text-cyan-300",
  },
  {
...
export const getStatusColor = (status: string): string => {
  ...
  return config?.color || "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300";
};
